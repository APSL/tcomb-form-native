...
class Textbox extends Component {
  ...
  isNumeric() {
    return this.typeInfo.innerType === t.Number || this.typeInfo.innerType.meta.name === 'Int';
  }

  getTransformer() {
    const options = this.props.options;
    return options.transformer ? options.transformer :
      this.isNumeric() ? Textbox.numberTransformer :
      Textbox.transformer;
  }
  ...
  getKeyboardType() {
    ...
    if (t.Nil.is(keyboardType) && this.isNumeric()) {
      return 'numeric';
    }
    return keyboardType;
  }
